...
public partial class RptAgent
{
    ...
    public int SumWorkInTime { get; set; }

    public int WorkInCnt { get; set; }

    public int SumWorkOutTime { get; set; }

    public int WorkOutCnt { get; set; }

    public int SumWorkExternalTime { get; set; }

    public int WorkExternalCnt { get; set; }

    public int SumWorkInternalTime { get; set; }

    public int WorkInternalCnt { get; set; }
    ...
    public int? CallAnsAcd { get; set; }

    public int? CallAnsFlow { get; set; }

    public int? CallAnsIntercom { get; set; }
}
